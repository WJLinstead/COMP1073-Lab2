...
function result() {
    var weightMeasure = " pounds";
    var tempMeasure = " farenheit";
    var weight = 300;
    var temperature = 94;
    var randomStory = "It was ";
    ...
    }//moved both steps 10 and 11 above to allow the variables to be changed
    ...
    newStory = randomStory.concat(temperature,tempMeasure," outside, so " , xItem , " went for a walk. When they got to ", yItem , " they stared in horror for a few moments , then " , zItem ,". ",newName," saw the whole thing, but he was not surprised — ", xItem," weighs ", weight , weightMeasure,", and it was a hot day.")
